...
int Change_File_L(LPWSTR Dest, LPCWSTR Dir, LPCWSTR Titre, LPCWSTR Filter, LPCWSTR Ext, HWND hwnd)
{
	OPENFILENAME ofn;
...
int Change_File_S(LPWSTR Dest, LPCWSTR Dir, LPCWSTR Titre, LPCWSTR Filter, LPCWSTR Ext, HWND hwnd)
{
	OPENFILENAME ofn;
